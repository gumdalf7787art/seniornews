...
export default function NewsSidebar({ excludeId, label = '추천 뉴스', className = '', showPopular = true, showLatest = true, showAd = false, banners = [], articles: providedArticles }) {
