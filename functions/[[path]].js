...
export async function onRequest(context){
  ...
  html=html.replace(/<title>.*?<\/title>/i,`<title>${escapeHtml(article.title)} | 시니어 라이프 뉴스</title>`).replace('<div id="root"></div>',`<div id="root">${serverArticle}</div>`);
